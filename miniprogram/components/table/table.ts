...
Component({
  ...
  lifetimes: {
    ...
    ready(): void {
      ...
      selector.exec((result: [SizeResult, SizeResult, SizeResult[], HeightResult[], WidthResult[], ScrollViewResult, ScrollViewResult]) => {
        const [
  ...
  methods: {
    ...
    getExtraCells: function (bodyViewportSize: string, sizes: string[], baseSize: string) {
    ...
    setViewportBounces: function (...viewports: ScrollViewResult[]) {
